...
| [`phase-1-shell-store-roster.md`](phase-1-shell-store-roster.md) | WO-1.1 … WO-1.52 | Phase 1 |
...
|---|---|---|---|---|
| 1 — Shell, store, roster | 52 | 43 | — | 🔨 IN PROGRESS (reopened nineteen times; last on 2026-09-03) |
...
| 6 — Calendar & glance | 9 | 6 | — | 🔨 IN PROGRESS |
