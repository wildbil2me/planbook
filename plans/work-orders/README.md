...
| 38 | [WO-5.6](phase-5-outreach.md#wo-56--a-draft-survives-a-change-of-mind) **A draft survives a change of mind** | S | — | **The first of the four the owner's 2026-08-29 sitting produced, and the one to build first.** The other three add capability; this one stops the app throwing away something a teacher typed — changing the template, the tone or the recipient rebuilds the draft with no warning and no undo. **Row 41 extends it rather than re-deciding it**, so building them the other way round means doing the confirm twice |
