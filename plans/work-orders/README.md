...
| 22 | [WO-5.3](phase-5-outreach.md#wo-53--send-flow) Send flow | M | — | After row 21. `mailto:` only — a mail scope reads "Send email as you," and the architecture table forbids it |
